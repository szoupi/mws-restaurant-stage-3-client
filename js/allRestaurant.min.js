...
function(b){b=void 0===b?self.restaurant:b;document.getElementById("restaurant-name").innerHTML=b.name;document.getElementById("restaurant-address").innerHTML=b.address;var c=document.getElementById("restaurant-img");c.className="restaurant-img";c.alt="image of "+b.name+" restaurant";c.src=DBHelper.imageUrlForRestaurant(b)+".jpg";document.getElementById("restaurant-cuisine").innerHTML=b.cuisine_type;b.operating_hours&&fillRestaurantHoursHTML();fillReviewsHTML()},fillReviewsHTML=function(){var b=self.restaurant.id,
c=document.getElementById("reviews-container"),a=document.createElement("h2");a.innerHTML="Reviews";c.appendChild(a);a=document.createElement("button");a.innerHTML="Your opinion matters! Add your comment";a.className="button";a.id="add-review-button";a.onclick=createForm;c.appendChild(a);DBHelper.fetchReviews(b).then(function(a){var b=document.getElementById("reviews-list");a.forEach(function(a){b.appendChild(createReviewHTML(a))});c.appendChild(b)})||(b=document.createElement("p"),b.innerHTML="No reviews yet!",
c.appendChild(b))},createForm=function(){var b=document.getElementById("add-review"),c=document.createElement("form"),a=document.createElement("label");a.htmlFor="reviewer_name";a.innerHTML="Your name:";c.append(a);a=document.createElement("input");a.type="text";a.name="reviewer_name";a.id="reviewer_name_fld";c.append(a);a=document.createElement("label");a.htmlFor="rating";a.innerHTML="Rating:";c.append(a);a=document.createElement("select");a.name="rating";a.id="rating_fld";for(var d=1;6>d;d++){var e=
document.createElement("option");e.innerHTML=d;e.value=d;a.append(e)}c.append(a);a=document.createElement("label");a.htmlFor="comment_text";a.innerHTML="Comment:";c.append(a);a=document.createElement("textarea");a.type="text";a.className="textarea";a.name="comment_text";a.id="comment_text_fld";c.append(a);a=document.createElement("button");a.className="button";a.id="submitReview";a.innerHTML="Submit Review";a.onclick=postReview;c.append(a);b.appendChild(c)};
